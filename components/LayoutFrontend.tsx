		...
		<div className="min-vh-100" style={{ background: '#000' }}>
			<div className="container" style={{ border: "1px solid red" }}>
				...
				<div className="row align-items-center">
					...
					<div className={classNames("col col-lg-10 align-self-stretch", styles.boxShadow)} style={{ border: '1px dashed grey' }}>
						<div className="d-flex flex-row justify-content-center align-items-center h-100" style={{ border: '1px dashed pink' }}>
				...
				<main className="" style={{ paddingBottom: '90px', border: '2px solid green' }}>
					{children}
				</main>

				<footer className={classNames("container fixed-bottom", styles.footer)} style={{}}>
					<div className="row">
